...
- **Do NOT use thinking/reasoning models** (e.g., deepseek-reasoner) in server mode — they output intent-only responses instead of executing tools. Use non-thinking models like `nvidia/nemotron-3-super-120b-a12b:free`. Thinking models work fine in Telegram DMs.
